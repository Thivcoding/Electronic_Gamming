...
import { mouseProducts } from '../../../Data'
import 'animate.css';
  ...
  return (
    <div className='w-full h-auto px-6 md:px-14'>
         <div className='w-full flex items-center justify-between pt-10 border-b py-3'>
            <h1 className='text-3xl  text-center font-bold  uppercase '>Product Of Category Mouses</h1>
