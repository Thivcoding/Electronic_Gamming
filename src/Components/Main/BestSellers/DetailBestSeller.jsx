...
const DetailBestSeller = () => {
  ...
  return (
    <div className='w-full px-5 lg:px-48 py-8'>
        <div className='w-full md:h-[480px] lg:h-[430px] flex flex-wrap bg-slate-500 shadow-sm shadow-sky-500 overflow-hidden rounded-xl '>
            {/* image */}
            ...
            <div className='w-full md:w-1/2 h-full text-white p-5 pb-7 md:p-10'>
                ...
                {/* button */}
                <div className='w-full h-auto flex justify-around mt-4 md:mt-8'>
                    <button 
                    onClick={()=>AddToCart(product)}
                    className='bg-blue-500 hover:translate-y-1  hover:shadow-md shadow-red-500/80 transition-all duration-300 ease-in-out cursor-pointer px-6 lg:px-8 py-3 text-white rounded-xl'>Add To Cart</button>
                    <Link to={'/'} className='bg-red-500 hover:translate-y-1  hover:shadow-md shadow-sky-500/80 transition-all duration-300 ease-in-out cursor-pointer px-6 lg:px-8 py-3 text-white rounded-xl'>Back To Product</Link>
                </div>
            </div>
        </div>
    </div>
